...
public class ComponentTestScript : MonoBehaviour
{
    ...
    [field: SerializeField] public double doubleField { get; private set; }

    public string stringField;
    [SerializeField] private string privateStringField;
    [field: SerializeField] public string serializedStringProperty { get; private set; }

    public Vector3 vector3Field;
    [SerializeField] private Quaternion quaternionField;
    [field: SerializeField] public Color colorProp { get; private set; }

    public int[] intArray;
    [SerializeField] private string[] stringArray;
    [field: SerializeField] public Vector3[] vector3Array { get; private set; }

    public List<int> intList;
    [SerializeField] private List<string> stringList;
    [field: SerializeField] public List<Color> colorList { get; private set; }

    public Dictionary<string, int> dictionaryField;
    [SerializeField] private Dictionary<int, string> privateDictionaryField;
    [field: SerializeField] public Dictionary<string, Vector3> serializedDictionary { get; private set; }
    ...
    [SerializeField] private NestedClass privateNestedClassField;
    [field: SerializeField] public NestedClass serializedNestedClass { get; private set; }

    public enum TestEnum { ValueA, ValueB, ValueC }

    public TestEnum enumField;
    [SerializeField] private TestEnum privateEnumField;
    [field: SerializeField] public TestEnum serializedEnumProperty { get; private set; }
    ...
    [SerializeField] private CustomStruct privateStructField;
    [field: SerializeField] public CustomStruct serializedStructProperty { get; private set; }

    public List<List<int>> nestedList;
    [SerializeField] private Dictionary<string, List<Vector3>> complexDictionary;
    [field: SerializeField] public HashSet<string> hashSetProperty { get; private set; }

    public int? nullableInt;
    [SerializeField] private float? nullableFloat;
    [field: SerializeField] public bool? nullableBool { get; private set; }

    public GameObject gameObjectField;
    [SerializeField] private Transform transformField;
    [field: SerializeField] public Rigidbody rigidbdyProperty { get; private set; }

    public GameObject[] gameObjectArray;
    [SerializeField] private List<Transform> transformList;
    [field: SerializeField] public List<Rigidbody> rigidbodyList { get; private set; }
